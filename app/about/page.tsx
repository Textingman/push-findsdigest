        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#6B7280' }}>
              The Finds Digest is an AI-powered platform that guides individuals through the benefits decision process with honest, unbiased education. We're not a benefits broker. We're your independent advisor.
            </p>
          </div>
        </div>
      </section>
