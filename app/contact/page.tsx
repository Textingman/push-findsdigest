          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <a
                  href="mailto:support@thefindsdigest.com"
              ...
              <div>
                ...
                <p style={{ color: '#6B7280' }}>
                  ...
                  <a href="mailto:support@thefindsdigest.com" className="font-medium hover:underline" style={{ color: '#EA580C' }}>
                    support@thefindsdigest.com
                  </a>.
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  Reply <strong>HELP</strong> to any SMS message or email us at support@thefindsdigest.com.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm" style={{ color: '#6B7280' }}>
                  ...
                  <a href="/privacy" className="font-medium hover:underline" style={{ color: '#EA580C' }}>Privacy Policy</a> for full details.
                </p>
              </div>
