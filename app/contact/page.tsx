            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  style={{ backgroundColor: submitting ? '#9CA3AF' : '#EA580C', cursor: submitting ? 'not-allowed' : 'pointer' }}
                >
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@thefindsdigest.com" className="text-base font-medium hover:underline" style={{ color: '#EA580C' }}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#6B7280' }}>
                    ...
                    <a href="/privacy" className="font-medium hover:underline" style={{ color: '#EA580C' }}>Privacy Policy</a>.
                  </p>
                </div>
                <div>
