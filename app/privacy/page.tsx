      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            The Finds Digest ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered benefits education service and website at thefindsdigest.com. By using our service, you agree to the collection and use of information in accordance with this policy.
          </p>
          ...
          <p className="mb-4" style={{ color: '#6B7280' }}>
            <strong>No mobile information will be shared or sold to third parties for marketing/promotional purposes.</strong> When you opt in to receive SMS messages from The Finds Digest, we collect and store your consent preferences separately for:
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            Each SMS program requires separate opt-in consent. Opting in to either or both programs is entirely optional and is not required to use our service or submit our form. You may opt out at any time by replying <strong>STOP</strong> to any message. For help, reply <strong>HELP</strong> or email <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>support@thefindsdigest.com</a>. Message and data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages.
          </p>
          ...
          <p className="mb-4" style={{ color: '#6B7280' }}>
            The Finds Digest operates two separate SMS messaging programs. By opting in to either program on our signup form, you agree to the following terms:
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
            ...
            <li>To get help, reply <strong>HELP</strong> or contact <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>support@thefindsdigest.com</a>.</li>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            To exercise these rights, please contact us at <a href="mailto:privacy@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>privacy@thefindsdigest.com</a>.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            If you are a California resident, you have specific rights under the California Consumer Privacy Act (CCPA), including the right to know what personal information we collect, the right to delete your personal information, and the right to opt out of the sale of personal information. <strong>We do not sell personal information.</strong> To exercise your CCPA rights, contact us at <a href="mailto:privacy@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>privacy@thefindsdigest.com</a>.
          </p>
          ...
          <div className="rounded-lg p-6 mb-8" style={{ backgroundColor: '#F5F7FA', border: '1px solid #E5E7EB' }}>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>Privacy Inquiries:</strong> <a href="mailto:privacy@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>privacy@thefindsdigest.com</a></p>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>General Support:</strong> <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F8FCB' }}>support@thefindsdigest.com</a></p>
            <p style={{ color: '#6B7280' }}><strong>Website:</strong> <a href="/" className="font-medium" style={{ color: '#2F8FCB' }}>https://thefindsdigest.com</a></p>
          </div>
