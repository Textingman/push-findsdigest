        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold mb-4" style={{ color: '#1F2937' }}>
              Talk to Your AI Giveaway Advisor — Free
            </h1>
            <p className="text-xl max-w-2xl mx-auto" style={{ color: '#6B7280' }}>
              Tell us what you're looking for and our AI agent will deliver personalized, unbiased giveaway guidance — no spam, no pressure, just honest answers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12" style={{ border: '1px solid #E5E7EB' }}>
          {submitStatus === 'success' ? (
            ...
            <>
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2" style={{ color: '#1F2937' }}>Connect with The Finds Digest AI</h2>
                <p style={{ color: '#6B7280' }}>
                  Fill out this form and our AI agent will provide you with unbiased, personalized giveaway guidance — completely free. No spam, no salespeople.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-2" style={{ color: '#1F2937' }}>
                    Tell Us What Giveaways You're Interested In (Optional)
                  </label>
                  <textarea
                    id="message"
                    name="message"
                    ...
                    style={{ border: '1px solid #E5E7EB' }}
                    placeholder="Tell us what types of giveaways, sweepstakes, or free samples you're looking for..."
                  />
                </div>
                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-account-notifications" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive transactional account notification text messages from The Finds Digest. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@thefindsdigest.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by The Finds Digest.
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg p-6 text-white" style={{ backgroundColor: '#1F2937' }}>
                    <div className="flex items-start">
                      ...
                      <label htmlFor="sms-customer-care" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive <strong>customer care</strong> text messages from The Finds Digest. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@thefindsdigest.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by The Finds Digest.
                      </label>
                    </div>
                  </div>
