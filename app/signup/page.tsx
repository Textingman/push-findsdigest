        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto" style={{ color: '#6B7280' }}>
              Tell us what you're looking for and our AI agent will deliver personalized, unbiased savings guidance — no spam, no pressure, just honest answers.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12" style={{ border: '1px solid #E5E7EB' }}>
          {submitStatus === 'success' ? (
            ...
            <>
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2" style={{ color: '#1F2937' }}>Get Started with The Finds Digest</h2>
                <p style={{ color: '#6B7280' }}>
                  Fill out this form and our AI agent will provide you with unbiased, personalized savings guidance — completely free. No spam, no salespeople.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-2" style={{ color: '#1F2937' }}>
                    Tell Us What Deals or Savings You're Looking For (Optional)
                  </label>
                  <textarea
                    id="message"
                    name="message"
                    ...
                    style={{ border: '1px solid #E5E7EB' }}
                    placeholder="Tell us what types of deals, discounts, or savings opportunities you're looking for..."
                  />
                </div>
