      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            By accessing or using The Finds Digest's AI-powered benefits education service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: '#1F2937' }}>2. Description of Service</h2>
          <p className="mb-6" style={{ color: '#6B7280' }}>
            The Finds Digest provides an AI-powered benefits education platform that helps individuals understand their benefits options through personalized, unbiased guidance. The Service includes:
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            The Finds Digest offers two optional SMS messaging programs: transactional account notifications and customer care messages. Opting in to either program is entirely voluntary and is not required to use the Service or submit our form. By checking the applicable opt-in checkbox on our signup form, you provide explicit consent to receive SMS messages from that program.
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3" style={{ color: '#1F2937' }}>5.2 Opt-Out</h3>
          <p className="mb-6" style={{ color: '#6B7280' }}>
            You may opt out of any SMS program at any time by replying <strong>STOP</strong> to any message from that program. Your opt-out request will be honored promptly. For help, reply <strong>HELP</strong> or contact <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F6FA3' }}>support@thefindsdigest.com</a>.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            We provide email support at <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F6FA3' }}>support@thefindsdigest.com</a>. Response times may vary based on the nature of your inquiry.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            The Service and all content, features, and functionality are owned by The Finds Digest and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            You agree to indemnify, defend, and hold harmless The Finds Digest and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and The Finds Digest regarding the Service and supersede all prior agreements.
          </p>
          ...
          <div className="rounded-lg p-6 mb-8" style={{ backgroundColor: '#F5F7FA', border: '1px solid #E5E7EB' }}>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>Legal:</strong> <a href="mailto:legal@thefindsdigest.com" className="font-medium" style={{ color: '#2F6FA3' }}>legal@thefindsdigest.com</a></p>
            <p className="mb-2" style={{ color: '#6B7280' }}><strong>Support:</strong> <a href="mailto:support@thefindsdigest.com" className="font-medium" style={{ color: '#2F6FA3' }}>support@thefindsdigest.com</a></p>
            <p style={{ color: '#6B7280' }}><strong>Website:</strong> <a href="/" className="font-medium" style={{ color: '#2F6FA3' }}>https://thefindsdigest.com</a></p>
          </div>
